			...
			<div class="row">
			    ...
			    <div class="tab-content">
			        <div class="tab-pane  active" id="tab1">
			            ...
			            <h2>Registro de Persona Júridica</h2>
							<form id="form-create-personaj" class="form-horizontal" role="form" action="<?php base_url();?>personaj/guardar" method="POST">
			        ...
			        <div class="tab-pane fade" id="tab2">
			            ...
			            <hr>
			            <div class="row">
			            	<div id="listaPersonaJ" class="col-lg-8">
			            		
			            	</div>
			            	<div class="col-lg-4">
			            		<div class="panel panel-default">
 									<div class="panel-heading">Editar Persona Júridica</div>
								  	<div class="panel-body">
								  		<form id="form-actualizar" class="form-horizontal" action="<?php echo base_url();?>personaj/actualizar" method="post" role="form" style="padding:0 10px;">
								  			<div class="form-group">
								  				<label>Nombre:</label>
...
<script src="<?php echo base_url();?>assets/js/personaj.js"></script>
